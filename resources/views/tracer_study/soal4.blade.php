            ...
            <div class="container"> 
              <div class="  label-background form-check border rounded"  style="padding:5px; margin: 2px; ">
                <button class="btn  button"  type="button">
                 <input type="radio" name="biaya" id="from-AFIRMASI" value="setingkat lebih tinggi" style="width: 20px;">
              ...
              <div class="  label-background form-check border rounded"  style="padding:5px; margin: 2px; ">
                <button class="btn  button"  type="button">
                 <input type="radio" name="biaya" id="from-AFIRMASI" value="tingkat sama">
                 <label class="form-check-label" for="from-AFIRMASI" >
                  Tingkat yang sama
                </label> 
              ...
              <div class="  label-background form-check border rounded"  style="padding:5px; margin: 2px; ">
                <button class="btn  button"  type="button">
                 <input type="radio" name="biaya" id="from-AFIRMASI" value="tingkat rendah">
                 <label class="form-check-label" for="from-AFIRMASI" >
                ...
                <div class="  label-background form-check border rounded"  style="padding:5px; margin: 2px; ">
                  <button class="btn  button"  type="button">
                   <input type="radio" name="biaya" id="from-AFIRMASI" value="tidak perluh pendidikan tinggi">
                   <label class="form-check-label" for="from-AFIRMASI" >
